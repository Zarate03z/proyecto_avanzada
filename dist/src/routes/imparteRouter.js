...
imparteRouter.get('/:cod_a', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    imparteController.getById(cod_a, (err, result) => {
        if (err) {
            return res.status(500).json({ 'message': err.message });
        }
        res.status(result.statusCode).json(result);
...
imparteRouter.put('/:cod_e', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const cod_e = parseInt(req.params.cod_a);
    const updatedimparte = Object.assign(Object.assign({}, req.body), { cod_e });
...
imparteRouter.delete('/:cod_a', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const cod_a = parseInt(req.params.cod_a);
    imparteController.remove(cod_a, (err, result) => {
        if (err) {
            return res.status(500).json({ 'message': err.message });
        }
        res.status(result.statusCode).json(result);
